...
//---  Draw  Pivot lines on chart
      ...
      ObjectSet("R1 line", OBJPROP_COLOR, Blue);
      }
      else
      {
      ...
      ObjectSet("R2 line", OBJPROP_COLOR, Blue);
      }
      else
      {
...
//---- Draw Midpoint Pivots on Chart
      ...
      ObjectSet("M5 line", OBJPROP_COLOR, Green);
      }
      else
      {
      ...
      ObjectSet("M4 line", OBJPROP_COLOR, Green);
      }
      else
      {
      ...
      ObjectSet("M3 line", OBJPROP_COLOR, Green);
      }
      else
      {
      ...
      ObjectSet("M2 line", OBJPROP_COLOR, Green);
      }
      else
      {
      ...
      ObjectSet("M1 line", OBJPROP_COLOR, Green);
      }
      else
      {
      ...
      ObjectSet("M0 line", OBJPROP_COLOR, Green);
      }
      else
      {
