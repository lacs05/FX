...
Comment("High= ",yesterday_high,"    ",day_high,"    Previous Days Range= ",nQ,"\nLow= ",yesterday_low,"    ",day_low,"    Current Days Range= ",nD,"\nClose= ",yesterday_close, "           Goodmorning JURGEN and Good Luck Trading!");
