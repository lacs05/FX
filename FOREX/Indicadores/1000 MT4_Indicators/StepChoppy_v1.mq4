...
//---- 
   SetIndexStyle(0,DRAW_HISTOGRAM,0,3,Blue);
   ...
   SetIndexStyle(4,DRAW_HISTOGRAM,0,3,Red);
...
int start()
  {
   ...
   double RSI, FastRSI, SlowRSI, StepMA, MA,UpTrendMA, DnTrendMA; 
//----
